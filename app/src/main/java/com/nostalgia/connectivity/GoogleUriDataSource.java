 ...
 * </ul>
 */
public final class GoogleUriDataSource implements UriDataSource {
     ...
     */
    public GoogleUriDataSource(Context context, String userAgent) {
     ...
     * @param userAgent The User-Agent string that should be used when requesting remote data.
     */
    public GoogleUriDataSource(Context context, TransferListener listener, String userAgent) {
    ...
    public GoogleUriDataSource(Context context, TransferListener listener, String userAgent,
        ...
        this(context, listener,
                new GoogleDataSource(userAgent, null, listener,
     ...
     */
    public GoogleUriDataSource(Context context, TransferListener listener,
