 ...
 */
public class CollectionViewHolder extends MediaViewHolder {
    ...
    public void bindItem(MediaCollectionWrapper toDisplay) {
        ...
        if(MediaCollectionWrapper.WrapperType.PERSONAL == toDisplay.getType()) {
            bindPersonalCollection(toDisplay);
        } else if(MediaCollectionWrapper.WrapperType.SHARED == toDisplay.getType()){
            bindSharedCollection(toDisplay);
        } else if(MediaCollectionWrapper.WrapperType.PUBLIC == toDisplay.getType()){
            bindPublicCollection(toDisplay);
        }
    }
    ...
    private void bindPersonalCollection(MediaCollectionWrapper wrapper){
        //Nothing specific to Nearby implemented yet.
        mCollectionWrapper = wrapper;
        bindMediaCollection(wrapper.getMediaCollection(), R.menu.collection_personal_options);
    }

    private void bindSharedCollection(MediaCollectionWrapper wrapper){
        //Nothing specific to Subscribed implemented yet.
        mCollectionWrapper = wrapper;
        bindMediaCollection(wrapper.getMediaCollection(), R.menu.collection_shared_options);
    }

    private void bindPublicCollection(MediaCollectionWrapper wrapper){
        //Nothing specific to Subscribed implemented yet.
        mCollectionWrapper = wrapper;
        bindMediaCollection(wrapper.getMediaCollection(), R.menu.collection_public_options);
    }
