 ...
 */
package com.nostalgia.controller.exoplayer.player;
...
import com.nostalgia.connectivity.GoogleUriDataSource;
...
public class HlsRendererBuilder implements DemoPlayer.RendererBuilder {
  ...
  private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
    ...
    public AsyncRendererBuilder(Context context, String userAgent, String url, DemoPlayer player) {
      ...
      playlistFetcher = new ManifestFetcher<>(url, new GoogleUriDataSource(context, userAgent),
          parser);
    }
    ...
    public void onSingleManifest(HlsPlaylist manifest) {
      ...
      DataSource dataSource = new GoogleUriDataSource(context, bandwidthMeter, userAgent);
