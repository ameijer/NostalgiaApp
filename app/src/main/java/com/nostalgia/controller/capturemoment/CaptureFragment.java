...
import com.nostalgia.view.AutoFitTextureView;
...
public class CaptureFragment extends Fragment
    ...
    private static final int FORWARD_CAM = 0;
    private static final int SELFIE_CAM = 1;
    ...
    private boolean mCurrentCameraDirection = false;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.capture_video, container, false);
    }
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            String cameraId;
            if(mCurrentCameraDirection) {
                cameraId = manager.getCameraIdList()[SELFIE_CAM];
                mCurrentCameraId = SELFIE_CAM;
                //manager.setTorchMode(cameraId, true);
            } else {
                cameraId = manager.getCameraIdList()[FORWARD_CAM];
                mCurrentCameraId = FORWARD_CAM;
                //manager.setTorchMode(cameraId, true);
            }
    ...
    public void flipCamera() {
        closeCamera();
        try {
            if (1 < manager.getCameraIdList().length) {
                mCurrentCameraDirection = !mCurrentCameraDirection;
            }
    ...
    private void updatePreview() {
        ...
        try {
            ...
            try {
                ...
                Log.e(TAG, "error in updatepreview", e);
            }
        } catch (CameraAccessException e) {
            e.printStackTrace();
        }
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        try {
            if (mCurrentCameraId == FORWARD_CAM) {
